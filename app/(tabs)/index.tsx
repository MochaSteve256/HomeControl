...
import { View as NativeView, Vibration, Switch, SafeAreaView } from "react-native";
  ...
  return (
    <View>
      ...
      <SafeAreaView style={{ flexDirection: "row" }}>
        <Button className="ml-0 py-5 px-2" title="START PC" onPress={() => {}} />
        ...
        <Button className="mr-0 py-0 px-3" onPress={() => handlePSUchange()}>
          <NativeView className="flex-row items-center py-10">
            ...
            <Switch className="mr-3" thumbColor={"white"} trackColor={{ false: "darkred", true: "lightgreen" }} value={psuOn} onValueChange={ () => {
              handlePSUchange();
